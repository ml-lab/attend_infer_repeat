    ...
    def _prior_loss(self, appearance_prior, where_scale_prior, where_shift_prior,
        ...
        with tf.variable_scope('prior_loss'):
            ...
            if appearance_prior is not None:
                ...
                what_kl = tf.reduce_sum(what_kl, -1, keep_dims=True)
                ...
                where_kl = tf.reduce_sum(scale_kl + shift_kl, -1, keep_dims=True)
        ...
        with tf.variable_scope('loss'):
            ...
            if self.baseline is not None:
                ...
                with tf.control_dependencies([self._train_step]):
                    self._train_step = self._make_baseline_train_step(baseline_opt, loss,
